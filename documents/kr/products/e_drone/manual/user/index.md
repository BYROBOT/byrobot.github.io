...
| 번호 | 기능                                                                                               |
|:----:|:---------------------------------------------------------------------------------------------------|
| 1    | 짧게 누르면 LCD 백라이트 ON/OFF, 길게 누르면 Return Home                                           |
| 2    | 길게 누르면 전원 ON/OFF                                                                            |
| 3    | Trim Pitch 증가(드론을 앞으로 향하게 함)                                                           |
| 4    | Trim Roll 감소(드론을 왼쪽으로 향하게 함)                                                          |
| 5    | Trim Roll 증가(드론을 오른쪽으로 향하게 함)                                                        |
| 6    | Trim Pitch 감소(드론을 뒤로 향하게 함)                                                             |
| 7    | 짧게 누르면 이전 조종 화면으로 전환, 길게 누르면 설정 화면으로 이동                                |
| 8    | 짧게 누르면 다음 조종 화면으로 전환, 길게 누르면 페어링(비행 중에는 작동하지 않음)                 |
| 9    | 기능 없음                                                                                          |
| 10   | 기능 없음                                                                                          |
| 11   | 기능 없음                                                                                          |
| 12   | 기능 없음                                                                                          |
