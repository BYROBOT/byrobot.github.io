**[*e_drive* for rust](index.md)** / **Intro**
...
생성한 프로젝트 폴더로 이동하면 **Cargo.toml** 파일이 있습니다. 이 파일을 텍스트 편집기로 열어서 아래와 같이 e_drive 라이브러리에 대한 의존성을 추가합니다. 뒤의 숫자 **1.0.0** 은 버젼입니다. 처음 시작하시는 분이라면 최신 버젼을 사용하시기 바랍니다.
