...
자동차 바퀴가 바닥에 닿은 정상 상태에서는 자동차 상단 앞부분(LED 부분)을 누르면 바닥에 있는 버튼이 눌러집니다.<br>
기본적인 **카드 읽기**와 **실행** 명령만 동작합니다.
...
자동차의 앞 부분이 위를 향하도록 세운 상태에서 버튼을 누르는 경우 **모드 변경**을 실행합니다.
...
자동차를 뒤집은 상태에서 버튼을 누르는 경우 **특수한 기능**을 실행합니다.
