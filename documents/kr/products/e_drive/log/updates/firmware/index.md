...
> - 버튼 짧은 누름으로 인식하는 시간을 300ms 이내에서 2초 이내로 변경
> - 버튼 길게 누름으로 인식하는 시간을 1.2초 이상에서 3초 이상으로 변경
> - 버튼 입력 시 정해진 기능을 수행하지 않는 상태일 때 경고음을 울리게 함
> - 버튼 입력 시 연속 입력으로 인식하는 시간을 0.5초에서 0.6초로 변경
> - 각 모드에 대한 기본색 변경
> - 카드 코딩 시 카드 입력 시작, 함수 입력 시작의 기본색을 변경
