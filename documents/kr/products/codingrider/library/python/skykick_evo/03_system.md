...
class ModelNumber(Enum):
    ...
    Drone_11_Drone_P1		= 0x000B1001,	# 65 drone, None coding
    Drone_11_Drone_P2		= 0x000B1002,	# reserve
    Drone_11_Drone_P3		= 0x000B1003,	# 65 drone, coding
    Drone_11_Drone_P4		= 0x000B1004,	# 95 battle drone
    Drone_11_Drone_P5		= 0x000B1005,	# skykick evolution drone
    
    Drone_11_Controller_P0	= 0x000B2000,	# 65 controller, None USB, BYROBOT
    Drone_11_Controller_P1	= 0x000B2001,	# 65 controller, USB
    Drone_11_Controller_P2	= 0x000B2002,	# 65 controller, None USB
    Drone_11_Controller_P3	= 0x000B2003,	# reserve
